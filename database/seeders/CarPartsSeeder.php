...
class CarPartsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $superCharger = Part::create([
            ...
            'part_description' => 'A supercharger is a type of engine modification that increases the power of an engine by increasing the flow of air into the engine. A turbo is typically a power modification, but can also be a fuel injection modification.',
            'part_category' => 'Engine',
        ]);
